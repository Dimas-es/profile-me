...
export function DaftarKoneksi() {
  ...
  return (
    <div className="bg-main-secondary rounded-lg shadow-sm border border-main-border w-full">
      ...
      <div className="p-3 sm:p-4 md:p-6 border-b border-main-border">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <h2 className="text-base sm:text-lg md:text-xl font-semibold text-main-text">{title}</h2>
      ...
      <div className="p-3 sm:p-4 md:p-6">
        ...
        <div className="flex justify-center mt-4 sm:mt-6 md:mt-8">
          <Button
            variant="ghost"
            size="responsive"
            className="text-main-text-secondary hover:text-main-text hover:bg-main-button/10"
          >
            {buttons.showMore}
          </Button>
        </div>
...
function KartuKoneksi({ koneksi }: { koneksi: KoneksiMutual }) {
  return (
    <div className="flex items-start gap-3 p-3 sm:p-4 rounded-lg hover:bg-main-primary/10 transition-colors cursor-pointer">
      {/* Avatar */}
