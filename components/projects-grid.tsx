  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{"Sophia's Projects"}</h2>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Team Projects</h2>
          <div className="relative w-full sm:w-auto">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
            <Input placeholder="Search" className="pl-10 w-full sm:w-64" />
          </div>
          ...
          {teamProjects.map((project) => (
            <Card key={project.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-4 sm:p-5">
                ...
                <p className="text-blue-600 text-xs sm:text-sm font-medium mt-1">Role: {project.role}</p>
                <p className="text-gray-600 text-xs sm:text-sm mt-2">{project.description}</p>
                <div className="mt-3 sm:mt-4">
                  <h4 className="font-medium text-xs sm:text-sm mb-1 sm:mb-2">Team</h4>
