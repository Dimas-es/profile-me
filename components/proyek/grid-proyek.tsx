  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-main-text">{headings.personalProjects}</h2>
      ...
      <div className="text-center">
        <Button
          variant="outline"
          size="responsive"
          className="rounded-full bg-main-button-secondary border-main-border text-main-text"
        >
      ...
      <div className="space-y-3 sm:space-y-4 md:space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-main-text">{headings.teamProjects}</h2>
          <div className="relative w-full sm:w-auto">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-main-text-third w-4 h-4" />
            <Input
              placeholder={placeholders.search}
                  ...
                  <div className="space-y-1">
                    {project.team.map((member, index) => (
                      <div key={index} className="flex items-center gap-2">
                        <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-main-primary rounded-full"></div>
                        <div>
